...
# Use "fork" by default on Linux and macOS; allow override via env.
_DEFAULT_WORKER_START_METHOD = "fork" if sys.platform.startswith("linux") or sys.platform == "darwin" else "spawn"
